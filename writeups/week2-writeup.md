...
![Laptop IP Address](images/week2-images/mac-ipaddr.png)
...
![Starting up webapp through Docker](images/week2-images/docker-up.png)
...
![Starting up ARP spoofing tool](images/week2-images/arp-spoof.png)
...
![Loading up webapp on iPhone](images/week2-images/iphone-webapp-login1.png)

6. Open the Wireshark app and select “Wi-Fi” as the filter.

![Starting up Wireshark](images/week2-images/wireshark.png)

7. Go back to the iPhone and sign into the web application.

![Typing in login credentials on webapp](images/week2-images/iphone-webapp-login2.png)
![Logging into the webapp](images/week2-images/iphone-webapp-homepage.png)
...
![Sorting Wireshark packets by IP address](images/week2-images/wireshark2.png)
...
![Applying HTTP POST protocol to packets](images/week2-images/wireshark3.png)

11. Upon clicking the packet, the login credentials can be seen in clear text.

![Examining the packet containing login credentials](images/week2-images/wireshark4.png)
