...
![Page only Admins can access on the webapp](images/week5-images/img0.png)
...
![Create user on webapp using Admin account](images/week5-images/img1.png)

2. Next, we’ll log into our account, create a vault, and save three passwords saved on it.

![Save passwords on newly made account](images/week5-images/img2.png)
...
![View of Developer Tools whilst on webapp](images/week5-images/img3.png)
...
![Forage our own cookie again](images/week5-images/img11.png)
...
![Unrightfully gain access to Admin panel](images/week5-images/img12.png)
...
![View of Developer Vault](images/week5-images/img13a.png)
![View of Executive Vault](images/week5-images/img13b.png)

14. To secure authorization, we’ll start by updating **login.php** like so:

![login.php code snippet](images/week5-images/img14.png)

15. Next, update the **admin-authorization.php** file like so:

![admin-authorization.php code snippet](images/week5-images/img15.png)

16. Update **logout.php** like so:

![logout.php code snippet](images/week5-images/img16.png)

17. Update **vault-details.php** like so:

![vault-details.php code snippet](images/week5-images/img17.png)

18. Update **nav-bar.php** like so:

![nav-bar.php code snippet](images/week5-images/img18.png)
...
![Find all instances of _COOKIE in project](images/week5-images/img19.png)

20. A search menu will appear where you can enter “_COOKIE” to find all of its instances.

![Reults for all instances of _COOKIE in project](images/week5-images/img20.png)
...
![All instances of _COOKIE replaced with _SESSION](images/week5-images/img21.png)
