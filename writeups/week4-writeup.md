...
![Viewing Customer Tokens Page](week4-images/img3.png)
...
![Create loggly-logger.php file](week4-images/img4.png)
...
![Create .env file](week4-images/img5.png)
...
![Modify login.php](week4-images/img8.png)
...
![Failed login example](week4-images/img9.png)
...
![Viewing all logs on Loggly](week4-images/img10.png)
...
![Details on failed login log](week4-images/img11.png)
...
![Code snippet](week4-images/img12.png)
...
![Code snippet](week4-images/img13.png)
...
![Code snippet](week4-images/img14.png)
![Code snippet](week4-images/img14b.png)
![code snippet](week4-images/img14c.png)
...
15. After making the changes, save the files, and relaunch the application using, “docker compose up –build”. When we log into our browser, we’ll see that we get logs for:
    ...
    ![Log detail on logging into account](week4-images/img15a.png)

    - Adding a new password to our vault

    ![Log detail on adding passwords](week4-images/img15b.png)

    - Deleting a password from out vault

    ![Log detail on deleting passwords fro a vault](week4-images/img15c.png)

    - Signing out of our account

    ![Log detail on signing out of account](week4-images/img15d.png)
...
![login.php code snippet](week4-images/ec1.png)
...
![login.php code snippet](week4-images/ec2.png)
...
![Logs showing brute force log-in attempts](week4-images/ec3.png)

![Webapp login page showing error message](week4-images/ec4.png)
